...
def cfg(min_pair_gap: int = 2, verifier: str = "cosine", test_fraction: float = 0.3) -> ReidConfig:
    return ReidConfig(
        verifier=verifier, min_pair_gap=min_pair_gap, max_pairs_per_track=200, observation_quantile=0.75, max_false_merge_rate=0.02, continuity_bonus=0.15, spatial_scale=2.0, temporal_scale=2.0,
